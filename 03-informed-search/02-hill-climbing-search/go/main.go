...
func successor(n []interface{}, end string, h int) [][]interface{} {
	var best []interface{}
	...
	for i := 0; i < len(s)-1; i++ {
		...
		score := heuristic(child, end, h)
		if score < bestScore {
			bestScore = score
			best = []interface{}{child, score, inc()}
		}		
	}
	if best != nil {
    	return [][]interface{}{best}
	}
	return [][]interface{}{}
}
